                ...
                <AnimatePresence>
                  {isNavDockExpanded && (
                    <motion.div
                      ...
                      className={`mr-2.5 px-3 py-1 rounded-xl text-xs font-bold whitespace-nowrap cursor-pointer transition-all flex items-center gap-1.5 shadow-sm ${
                        isActive
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 bg-sky-50/80 p-1.5 rounded-2xl border border-sky-100/90 shadow-inner">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "software" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "hardware" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "industrial" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "professional" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "consumer" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                          activeDirTab === "cities" ? "bg-sky-600 text-white shadow-md font-black" : "text-slate-600 hover:text-slate-900 hover:bg-white/60"
                        }`}
                      >
